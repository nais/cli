	...
	return &cli.Command{
		...
		Flags: []cli.Flag{
			...
			&cli.StringFlag{
				...
				Action: func(context *cli.Context, flag string) error {
					...
					if !service.Is(&aiven_services.Kafka{}) {
						metrics.AddOne("nais_cli", "aiven_create_pool_error_total")
			...
			&cli.StringFlag{
				...
				Action: func(context *cli.Context, flag string) error {
					...
					if !service.Is(&aiven_services.OpenSearch{}) {
						metrics.AddOne("nais_cli", "aiven_create_instance_error_total")
			...
			&cli.StringFlag{
				...
				Action: func(context *cli.Context, flag string) error {
					...
					if !service.Is(&aiven_services.OpenSearch{}) {
						metrics.AddOne("nais_cli", "aiven_create_access_error_total")
		...
		Before: func(context *cli.Context) error {
			...
			if context.Args().Len() < 3 {
				metrics.AddOne("nais_cli", "aiven_create_required_args_error_total")
		...
		Action: func(context *cli.Context) error {
			...
			if err != nil {
				metrics.AddOne("nais_cli", "aiven_create_pool_values_error_total")
			...
			if err != nil && service.Is(&aiven_services.OpenSearch{}) {
				metrics.AddOne("nais_cli", "aiven_create_access_value_error_total")
			...
			if err != nil {
				metrics.AddOne("nais_cli", "aiven_create_generating_aivenapplication_error_total")
