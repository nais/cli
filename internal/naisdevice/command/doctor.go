...
func examination(out *naistrix.OutputWriter) doc.Examination {
...
func kolideWorker(checkName string, out *naistrix.OutputWriter) doc.Worker {
...
func isRunning(desiredProc string, out *naistrix.OutputWriter) (bool, error) {
