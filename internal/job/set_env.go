...
func SetJobEnv(ctx context.Context, team, jobName, env string, updates []EnvVarUpdate) (string, error) {
	_ = `# @genqlient
	...
	resp, err := gql.SetJobEnv(ctx, client, team, jobName, env, envVars)
	if err != nil {
		return "", err
	}
